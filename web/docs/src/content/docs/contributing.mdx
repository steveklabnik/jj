...
[this PR](https://github.com/jj-vcs/jj/pull/7493#issuecomment-3289020874).
...
[https://docs.jj-vcs.dev/latest](https://docs.jj-vcs.dev/latest), which in turn redirects to
...
[https://docs.jj-vcs.dev/](https://docs.jj-vcs.dev/) (instead of the usual `main` bookmark).
...
from [https://docs.jj-vcs.dev/](https://docs.jj-vcs.dev/) and something fails weirdly, you might want
